...
// Sortable Item Component with Edit
function SortablePlayer({ player, index, onRemove, onEdit }) {
    const [isEditing, setIsEditing] = useState(false);
    const [editValue, setEditValue] = useState(player);
    ...
    const handleSave = () => {
        if (editValue.trim() && editValue !== player) {
    ...
    return (
        <li ref={setNodeRef} style={style} {...dragProps}>
            {isEditing ? (
                <>
                    <input
                        type="text"
                            ...
                            <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                                {players.map((player, index) => (
                                    <SortablePlayer
                                        ...
                                        onEdit={(newName) => editPlayer(index, newName)}
                                    />
                                ))}
                            </ul>
                        </SortableContext>
