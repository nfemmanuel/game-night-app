...
function LandingPage() {
    ...
    const games = [
        { name: "Mafia", modes: ["in-person"], route: "/mafia-setup", available: true, color: "color1" },
        ...
        { name: "UNO", modes: ["virtual", "single"], route: "/uno-setup", available: true, color: "color2" },
        { name: "UNO: No Mercy", modes: ["virtual", "single"], route: "/uno-nm-setup", available: true, color: "color1" },
