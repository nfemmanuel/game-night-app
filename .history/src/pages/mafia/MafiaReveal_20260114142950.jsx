...
function MafiaReveal() {
    ...
    const nextPlayer = () => {
        ...
        if (currentPlayerIndex < gameState.players.length - 1) {
            ...
            // Pass complete gameState as plain object for reconstruction
            navigate('/mafia-game', {
                state: { 
                    gameState: {
                        ...
                        killedThisNight: gameState.killedThisNight,
                        revivedThisNight: gameState.revivedThisNight,
                        suspectedThisDay: gameState.suspectedThisDay,
                        votedOutThisDay: gameState.votedOutThisDay,
                        mafiaActionTaken: gameState.mafiaActionTaken,
                        doctorActionTaken: gameState.doctorActionTaken,
                        detectiveActionTaken: gameState.detectiveActionTaken,
                        doctorHasSavedSelf: gameState.doctorHasSavedSelf,
