...
function UnoGame() {
    ...
    // CPU turn - defined with useCallback to avoid initialization issues
    ...
    useEffect(() => {
        ...
        // If CPU starts, trigger CPU turn after cpuTurn is defined
        if (!startingPlayer.isHuman) {
            setTimeout(() => {
                // cpuTurn will be available here because useEffect runs after render
                if (cpuTurn) {
                    cpuTurn();
                }
            }, 1500);
        }
    }, [playerName, numPlayers, cpuTurn]);
    ...
    const handleDrawCard = () => {
        ...
        console.log('Drew card:', card.toString()); // Debug log
