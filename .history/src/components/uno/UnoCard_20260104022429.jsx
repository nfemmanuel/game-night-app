...
function renderCardValue(card) {
    ...
    if (card.value === 'reverse') {
        return (
            <g>
                {/* Top arrow pointing up and curling */}
                <path
                    d="M 40 45 Q 50 40, 50 30 L 50 35 L 55 30 L 50 25 L 50 30"
                    fill="none"
                    stroke={color}
                    strokeWidth="4"
                    strokeLinecap="round"
                ...
                />
                <path
                    d="M 50 30 L 45 35 L 50 35"
                    fill={color}
                />

                {/* Bottom arrow pointing down and curling */}
                <path
                    d="M 40 75 Q 30 80, 30 90 L 30 85 L 25 90 L 30 95 L 30 90"
                    fill="none"
                    stroke={color}
                    strokeWidth="4"
                    strokeLinecap="round"
