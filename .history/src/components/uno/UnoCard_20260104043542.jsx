...
function renderCardValue(card) {
    ...
    if (card.value === 'reverse') {
        return (
            <g>
                {/* Top curved arrow - curls right and UP */}
                <path
                    d="M 25 50 Q 25 35, 40 35 Q 55 35, 55 50"
                    fill="none"
                    stroke={color}
                    strokeWidth="5"
                    strokeLinecap="round"
                ...
                <path
                    d="M 55 50 L 52 55 L 58 55 Z"
                    fill={color}
                />

                {/* Bottom curved arrow - curls left and DOWN */}
                <path
                    d="M 55 70 Q 55 85, 40 85 Q 25 85, 25 70"
                    fill="none"
                    stroke={color}
                    strokeWidth="5"
                    strokeLinecap="round"
