...
class GameState {
    ...
    playCard(player, card, chosenColor = null) {
        ...
        // FIXED: Wild Color Roulette does NOT set color here
        // The NEXT player will choose the color when they draw
        if (card.card_type === 'wild' && card.value !== 'wild_color_roulette') {
            ...
            // Don't set color yet - next player will choose it
    ...
    applyCardEffect(card) {
        if (card.card_type === 'action') {
            ...
            // FIXED: Next player chooses color AND draws
    ...
    // FIXED: Now also sets the currentColor to the chosen color
    drawUntilColor(player, chosenColor) {
        ...
        // FIXED: Set the discard pile color to what the next player chose
        this.currentColor = chosenColor;
